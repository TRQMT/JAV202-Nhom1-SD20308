...
<div class="visual-panel">
    ...
    <div class="brand-area">
        ...
        <div class="brand-tagline">Tạo tài khoản để bắt đầu</div>
    </div>
...
<div class="form-panel">
    <div class="form-inner">
        <div class="form-heading">Đăng ký tài khoản</div>
        <div class="form-sub">Tạo tài khoản mới và xác minh bằng mã OTP email</div>
        ...
        <c:choose>
            <c:when test="${step == 'verify'}">
                <div class="form-sub otp-email" style="margin-bottom:1rem;">
                    Nhập OTP đã gửi đến email: <strong>${email}</strong>
                </div>
                <form method="post" action="${pageContext.request.contextPath}/dang-ky" autocomplete="off">
                    <input type="hidden" name="action" value="verify">
                    <div class="field" style="margin-bottom:1.4rem;">
                        <label>Mã OTP</label>
                        <div class="input-wrap">
                            <span class="material-symbols-outlined icon">pin</span>
                            <input type="text" maxlength="6" name="otp" placeholder="Nhập 6 chữ số" required autofocus>
                        </div>
                    </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/dang-ky" autocomplete="off">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="phone" value="${phone}" placeholder="09xxxxxxxx" required>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="email" name="email" value="${email}" placeholder="ban@mycafe.vn" required>
                        </div>
                    </div>
        ...
        <div class="form-links">
            <a href="${pageContext.request.contextPath}/dang-nhap">Đã có tài khoản? Đăng nhập</a>
        </div>
    </div>
</div>
